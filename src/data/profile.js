...
export const profile = {
  name: 'Abirami Saravanan',
  // Cycled by the hero's typewriter effect; the first entry is what screen
  // readers and reduced-motion users get as the static role.
  ...
  socials: [
    { label: 'GitHub', url: 'https://github.com/abirami2k1' },
    { label: 'LinkedIn', url: 'https://www.linkedin.com/in/abirami2k1' },
  ],
}
