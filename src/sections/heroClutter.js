...
export const ARRANGEMENTS = {
  ...
  cleanup: {
    header: { x: 67, y: 45, center: false },
    items: [
      { id: 'heart', x: 62, y: 10, rotation: 0 },
      { id: 'bison', x: 3, y: 60, rotation: 0 },
      { id: 'escape', x: 84, y: 6, rotation: 0 },
      { id: 'error404', x: 22, y: 68, rotation: 0 },
      { id: 'loading', x: 72, y: 62, rotation: 0 },
      { id: 'note', x: 2, y: -2, rotation: 0 },
      { id: 'kolam', x: 7, y: 22, rotation: 0 },
      { id: 'pen', x: 53, y: 58, rotation: -45 },
      { id: 'art', x: 62, y: 38, rotation: 0 },
      { id: 'robot', x: 40, y: 60, rotation: 0 },
      { id: 'photo', x: 26.5, y: 5, rotation: 0 },
    ],
  },
  notebook: {
    header: { x: 50, y: 47.5, center: true },
    items: [
      ...
      { id: 'loading', x: 35, y: 65, rotation: -3 },
